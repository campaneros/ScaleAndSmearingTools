...
//
/**\class EleNewEnergiesProducer EleNewEnergiesProducer.cc ECALELF/ZNtupleDumper/plugins/EleNewEnergiesProducer.cc
...
class EleNewEnergiesProducer : public edm::stream::EDProducer<> 
{
